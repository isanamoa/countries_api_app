...
const SearchBar = () => {
    ...
    return (
        <div className={`w-full md:w-2/6 p-1 mb-10 ${modeContext.darkMode ? 'bg-[#2B3844] border border-transparent text-white' : 'bg-white border border-transparent text-black'}`}>
